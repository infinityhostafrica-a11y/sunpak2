    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground">Authenticating Details...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-12">
      <AnimatedSection>
        <div className="flex items-center text-sm text-muted-foreground mb-8">
          ...
          <Link href="/plots-for-sale" className="hover:text-primary">Projects</Link>
          <ChevronRight className="h-4 w-4 mx-1" />
          ...
          <div className="lg:col-span-2 flex flex-col justify-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" variant="outline" className="flex-1 font-black uppercase tracking-widest h-14 border-primary/20" asChild>
                <Link href={`https://wa.me/254790611601?text=I'd like to discuss financing for the ${listing.name} project.`} target="_blank">
                  Request Financing
                </Link>
              </Button>
            </div>
